 ...
 */
public class SqsFunctionPoller implements RequestHandler<SQSEvent, String> {

    Logger log = LogManager.getLogger(SqsFunctionPoller.class);
    Random random = new SecureRandom();

    static {
        // https://docs.aws.amazon.com/sdk-for-java/latest/developer-guide/lambda-optimize-starttime.html
        SdkHttpClient sdkHttpClient = UrlConnectionHttpClient.create();
